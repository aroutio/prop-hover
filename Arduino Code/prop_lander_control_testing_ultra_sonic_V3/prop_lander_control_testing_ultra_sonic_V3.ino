...
int desiredDerivativeRateMin = 40; // cm/s
int desiredDerivativeRateMax = 60; // cm/s
...
void loop() 
{
  ...
  if (currentTime - previousTime >= deltaTime * 1000) {
    ...
    int currentHeight = distance; // Read height sensor
    ...
    if (derivative == 20 && previousOutput < velocityConstrainedMaxThrottle) {
